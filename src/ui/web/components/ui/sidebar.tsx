 ...
 * this file and silently reverts all three edits, so they are named here:
 *
 * 1. Every reader-facing label — the trigger's and the rail's "Toggle Sidebar",
 *    the mobile sheet's title and description — calls `t()`. Stock shadcn
 *    hardcodes English, which ships untranslated copy to every locale; see
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t("nav.views")}</SheetTitle>
            <SheetDescription>{t("nav.sidebar-mobile")}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{t("nav.sidebar-toggle")}</span>
    </Button>
  )
}
