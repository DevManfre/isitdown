...
| `GET` | `/config` | Servizi, impostazioni di polling, `retention`, canali, routing e `removed` — i provider rimossi ma ancora ripristinabili. Le credenziali dei canali appaiono come **nomi** di variabili con un flag `isSet`, mai come valori. |
...
| `PATCH` | `/config/settings` | Impostazioni di polling e `retentionDays` — per quanto tempo si conserva lo storico, da 7 a 3650 giorni. |
